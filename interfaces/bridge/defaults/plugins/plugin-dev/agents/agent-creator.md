...
3. **Select Configuration**:
   - **Model**: Use `inherit` unless the user names a provider, in which case use that provider name
...
This agent automates agent creation using the proven patterns from Nosis's internal implementation, making it easy for users to create high-quality autonomous agents.
