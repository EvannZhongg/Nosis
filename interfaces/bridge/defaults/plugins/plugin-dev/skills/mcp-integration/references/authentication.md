...
Complete guide to authentication methods for MCP servers in Nosis plugins.
...
Nosis automatically handles the complete OAuth 2.0 flow for SSE and HTTP servers:

1. User attempts to use MCP tool
2. Nosis detects authentication needed
3. Opens browser for OAuth consent
4. User authorizes in browser
5. Tokens stored securely by Nosis
...
No additional auth configuration needed! Nosis handles everything.
...
Tokens are stored securely by Nosis:
