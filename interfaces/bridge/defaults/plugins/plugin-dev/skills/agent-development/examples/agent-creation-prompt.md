...
Use this template to generate agents using Nosis with the agent creation system prompt.
...
Send this to Nosis (with the agent-creation-system-prompt loaded):
...
tools: ["read_file", "write_file", "search_files"]  # Optional: restrict tools
---
...
model: inherit
color: blue
tools: ["read_file", "search_files", "search_files"]
---
...
Tell Nosis when the agent should activate:
...
- **Comprehensive**: Nosis includes edge cases and quality checks
