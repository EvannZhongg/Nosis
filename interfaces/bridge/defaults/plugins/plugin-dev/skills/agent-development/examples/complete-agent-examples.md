...
**Code Review Process:**
1. **Gather Context**: Use search_files to find recently modified files (git diff, git status)
...
model: inherit
color: cyan
tools: ["read_file", "write_file", "search_files", "search_files"]
---
...
- **Read-only agents**: `["read_file", "search_files", "search_files"]`
- **Generator agents**: `["read_file", "write_file", "search_files"]`
- **Executor agents**: `["read_file", "write_file", "shell", "search_files"]`
