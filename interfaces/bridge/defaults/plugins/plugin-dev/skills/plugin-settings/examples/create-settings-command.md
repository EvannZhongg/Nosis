...
allowed-tools: ["write_file", "ask_user"]
---

# Create Plugin Settings

This command helps users create a `.nosis/my-plugin.local.md` settings file.
...
Use write_file tool to create `.nosis/my-plugin.local.md`:
...
To modify settings, edit this file and restart Nosis.
```

### Step 4: Inform User

Tell the user:
- Settings file created at `.nosis/my-plugin.local.md`
- Current configuration summary
- How to edit manually if needed
- Reminder: Restart Nosis for changes to take effect
