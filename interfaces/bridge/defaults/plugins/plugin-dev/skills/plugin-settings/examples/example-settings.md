...
**.nosis/experimental-features.local.md:**
...
# Read settings
FRONTMATTER=$(sed -n '/^---$/,/^---$/{ /^---$/d; p; }' ".nosis/my-plugin.local.md")
...
Changes require Nosis restart - hooks can't be hot-swapped.
