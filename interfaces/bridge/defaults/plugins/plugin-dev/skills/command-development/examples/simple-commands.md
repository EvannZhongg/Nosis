...
**Important:** All examples below are written as instructions FOR Nosis (agent consumption), not messages TO users. Commands tell Nosis what to do, not tell users what will happen.

## Example 1: Code Review Command

**File:** `.nosis/commands/review.md`
...
**File:** `.nosis/commands/security-review.md`
...
**File:** `.nosis/commands/test-file.md`

```markdown
---
description: Run tests for specific file
argument-hint: [test-file]
allowed-tools: shell(npm:*), shell(jest:*)
---
...
**File:** `.nosis/commands/document.md`
...
**File:** `.nosis/commands/git-status.md`
...
**File:** `.nosis/commands/deploy.md`

```markdown
---
description: Deploy to specified environment
argument-hint: [environment] [version]
allowed-tools: shell(kubectl:*), read_file
---
...
**File:** `.nosis/commands/compare-files.md`
...
**File:** `.nosis/commands/quick-fix.md`
...
**File:** `.nosis/commands/research.md`
...
**File:** `.nosis/commands/explain.md`
