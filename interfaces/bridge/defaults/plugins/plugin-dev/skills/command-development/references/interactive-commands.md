...
allowed-tools: ask_user, write_file
---
...
Create `.nosis/plugin-name.local.md` with:
...
allowed-tools: ask_user, read_file, write_file, shell
---
...
allowed-tools: ask_user, read_file, write_file
---
...
allowed-tools: ask_user, write_file, read_file
---
...
Save to `.nosis/config-partial.yml`
...
allowed-tools: ask_user, shell, read_file
---
