...
Comprehensive guidance on creating Nosis slash commands, including file format, frontmatter options, dynamic arguments, and best practices.
...
- shell execution with !` syntax
- Command organization and namespacing
- Best practices for command development
- Plugin-specific features (plugin-relative paths, plugin patterns)
...
**Plugin-Specific:**
- Plugin-relative path conventions
...
- **plugin-features-reference.md**: Plugin-specific command features
  - Plugin command discovery and organization
  - Plugin-relative path conventions usage
  - Plugin command patterns (configuration, template, multi-script)
...
Nosis activates this skill when users:
...
Nosis loads references and examples as needed based on task.
...
- **Project**: `.nosis/commands/` (shared with team)
- **Personal**: `~/.nosis/commands/` (your commands)
...
| `allowed-tools` | Restrict tool access | `read_file, shell(git:*)` |
| `model` | Pin a provider | `inherit` or a provider name |
...
- ✓ Plugin command patterns (plugin-relative paths, discovery, organization)
...
6. Test examples work with current Nosis
