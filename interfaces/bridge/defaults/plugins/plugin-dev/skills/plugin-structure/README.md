...
Comprehensive guidance on Nosis plugin architecture, directory layout, and best practices.
...
- Ask about "plugin-relative paths" usage
...
Nosis loads references and examples only as needed based on the task.
