...
Tests individual hook scripts with sample input before deploying to Nosis.
...
**Features:**
- Runs hook scripts from the plugin root so relative paths resolve
...
- Path in hooks.json is correct (relative to the plugin root)
